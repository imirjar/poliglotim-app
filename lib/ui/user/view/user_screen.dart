      ...
      builder: (context, constraints) {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            flexibleSpace: UserHeader(viewModel:  viewModel, screenWidth: screenWidth, horizontalPadding: horizontalPadding, verticalPadding:verticalPadding),
          ),
          body: UserBody(viewModel: viewModel),
        );
      }
    );
  }
